(function() {
    ...
    var camAng =
        ...
        start = function() {
            ...
            camera.position.set(77.82504298529939, 190.02121980722944, 370.02178601347767);
    ...
    draw = function() {
        light2 = new THREE.DirectionalLight(0x000000, 9);
        light2.position.set(0, 0, 1000);
        light2.castShadow = true;
        scene.add(light2);
        jsonLoader = new THREE.ObjectLoader;
        return jsonLoader.load('met/met.json', addMesh);
    };
