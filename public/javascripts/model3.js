(function() {
    ...
    var camAng =
        ...
        start = function() {
            ...
            camera.position.set(57.82504298529939, 40.02121980722944, 370.02178601347767);
            camera.rotation.set(-20.4020274682629177, 10.6097939469542306, 20.6601321578044113);
            camera.lookAt(scene.position + 1060);
            scene.add(camera);
            ...
            container = document.getElementById('threejs3');
            container.appendChild(renderer.domElement);
            clock = new THREE.Clock;
        };


    var hemiLight, jsonLoader, light2;


    draw = function() {
        light2 = new THREE.DirectionalLight(0x98FB98, 1);
        light2.position.set(0, 0, 2000);
        light2.castShadow = true;
        scene.add(light2);
        jsonLoader = new THREE.ObjectLoader;
        return jsonLoader.load('dragonstl.json', addMesh);
    };
